...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Funcionarios')),
      body: FutureBuilder<List<Employer>>(future: EmployersDatabase.instance.readAllEmployer() ,builder: (context, snapshot) {
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => const RegistrationEmp(),),).then((value) => setState((){}));
        },
